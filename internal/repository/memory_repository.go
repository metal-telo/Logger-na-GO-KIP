...
func (r *MemoryRepository) GetDepartments(ctx context.Context) ([]domain.Department, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *MemoryRepository) GetEmployeesByDepartment(ctx context.Context, departmentID string) ([]domain.Employee, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *MemoryRepository) SearchEmployees(ctx context.Context, req domain.EmployeeSearchRequest) ([]domain.Employee, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *MemoryRepository) CreateEmployee(ctx context.Context, emp domain.Employee) (*domain.Employee, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *MemoryRepository) UpdateEmployee(ctx context.Context, emp domain.Employee) (*domain.Employee, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *MemoryRepository) UpdateEmployeeStatus(ctx context.Context, id string, status string) (*domain.Employee, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
